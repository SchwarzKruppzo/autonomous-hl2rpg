ITEM.name = "Черная рубашка \"Ingotex-13\""
...
ITEM.rarity = 1
ITEM.description = "Черного цвета рубашка от корпорации \"Ingotex-13\", созданная из качественных материалов. Имеется значок Вселенского Союза."
