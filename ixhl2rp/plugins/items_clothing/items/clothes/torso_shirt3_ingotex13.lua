ITEM.name = "Серая рубашка \"Ingotex-13\""
...
ITEM.rarity = 1
ITEM.description = "Серого цвета рубашка от корпорации \"Ingotex-13\", созданная из качественных материалов. Имеется значок Вселенского Союза."
