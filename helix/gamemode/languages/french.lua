...
hasBag									= "Vous ne pouvez pas porter plus d'un sac."
...
charcreate_faction						= "FACTION /// CRÉATION DE PERSONNAGE"
charcreate_visual						= "APPARENCE /// CRÉATION DE PERSONNAGE"
charcreate_left							= "BIO DU PERSONNAGE"
charcreate_right						= "APPARENCE"

charcreate_name							= "NOM"
charcreate_random						= "NOM ALÉATOIRE"
charcreate_phys							= "DESCRIPTION PHYSIQUE"

char_age								= "ÂGE: "
char_height								= "TAILLE: "
char_eye								= "COULEUR DES YEUX: "
char_shape								= "MORPHOLOGIE: "
char_lang								= "LANGUE MATERNELLE: "

charcreate_secondary					= "ADDITIONNEL"
charcreate_type							= "CHOISIR LE GENRE"
charcreate_model						= "APPARENCE"

charcreate_back							= "RETOUR"
charcreate_next							= "SUIVANT"
charcreate_apply						= "CRÉER LE PERSONNAGE"
charcreate_attributes					= "ATTRIBUTS /// CRÉATION DE PERSONNAGE"
charcreate_available					= "DISPONIBLE"
charcreate_freePoints					= "POINTS LIBRES"
charcreate_choose						= "CHOISIR"
charcreate_primaryAttributes			= "ATTRIBUTS PRINCIPAUX"
charcreate_primaryAttribute				= "ATTRIBUT PRINCIPAL"
charcreate_primaryAttributeDesc			= "ATTRIBUT DU PERSONNAGE"
charcreate_primaryAttributeHint			= "Affecte le coût d'augmentation de l'attribut du personnage. L'attribut principal est augmenté sans pénalité, les autres coûtent 4 points."
charcreate_citizen						= "CITOYEN"
tab_characteristics						= "ATTRIBUTS"
tab_health								= "ÉTAT DE SANTÉ"
tab_info								= "INFORMATIONS RP"
tab_perks								= "APTITUDES"
tab_equipment							= "ÉQUIPEMENT"
label_cid								= "N° DE CITOYEN"
panel_developing							= "Panneau en cours de développement."
tab_character								= "PERSONNAGE"
tab_equip_outer							= "VÊTEMENTS EXTÉRIEURS"
tab_equip_under							= "SOUS-VÊTEMENTS"
tab_craft									= "FABRICATION"
tab_to_mainmenu							= "MENU PRINCIPAL"
...
tab_tokens									= "JETONS"
tab_level									= "NIVEAU"
tab_xp_until								= "JUSQU'AU SUIVANT : %s XP"
tab_profile								= "PROFIL DU PERSONNAGE"
tab_basics									= "BASIQUE"
tab_phys_desc								= "DESCRIPTION PHYSIQUE"
tab_appearance_desc						= "DESCRIPTION EXTÉRIEURE"
tab_notes									= "NOTES PERSONNELLES"
tab_skills									= "COMPÉTENCES"
tab_special_tooltip						= "CARACTÉRISTIQUE DU PERSONNAGE"
tab_consciousness							= "CONSCIENCE :"
tab_pain									= "DOULEUR :"
tab_hunger									= "FAIM :"
tab_thirst									= "SOIF :"
tab_health_label							= "SANTÉ :"
tab_backpack								= "SAC À DOS"
tab_slot_torso								= "TORSE"
tab_slot_head								= "TÊTE"
tab_slot_legs								= "JAMBES"
tab_slot_face								= "VISAGE"
tab_slot_ears								= "OREILLES"
tab_slot_shoulder							= "ÉPAULE"
tab_slot_hands								= "MAINS"
tab_radio									= "RADIO"
tab_name									= "NOM"
tab_gender									= "GENRE"
n_a											= "N/D"
...
Outfit									= "Tenue"
Weapons									= "Armes"
itemContrabandWarning						= "Est une contrebande : possession et transport sont interdits."
...
charDeleted								= "Le personnage %s a été supprimé !"
charBanned								= "Ce personnage est banni."
charBannedTemp							= "Ce personnage est temporairement banni."
...
vendorStockReq							= "Entrez la quantité maximale d'articles."
vendorStockCurReq						= "Entrez le nombre d'articles disponibles à l'achat."
you										= "Vous"
...
tellAdmin								= "Signalez cette erreur à un administrateur: %s"

mapAdd									= "Vous avez ajouté une scène de carte."
mapDel									= "Vous avez supprimé %d scène(s) de carte."
mapRepeat								= "Maintenant ajoutez le deuxième point."
...
option.openBags							= "Sacs ouverts avec inventaire"
option.openBags.desc					= "Visualise automatiquement tous les sacs de votre inventaire lorsque le menu est ouvert."
option.showIntro						= "Afficher l'intro au démarrage"
option.showIntro.desc					= "Affiche l'introduction de Helix la prochaine fois que vous vous inscrivez. Ceci est toujours désactivé après l'avoir regardé."
option.cheapBlur						= "Désactiver le flou"
option.cheapBlur.desc					= "Remplace le flou de l'interface utilisateur par une simple gradation."
option.observerTeleportBack				= "Retour à l'emplacement précédent"
option.observerTeleportBack.desc		= "Vous ramène à l'emplacement où vous êtes entré en mode observateur."
option.observerESP						= "Montrer l'ESP admin"
option.observerESP.desc					= "Affiche les noms et les emplacements de chaque joueur sur le serveur."
option.hour24Time						= "Utilisez le temps de 24 heures"
option.hour24Time.desc					= "Afficher les horodatages sur 24 heures au lieu de 12 heures (AM / PM)."
option.chatNotices						= "Afficher les avis dans le chat"
option.chatNotices.desc					= "Met à la place tous les avis qui apparaissent en haut à droite dans le chat."
option.chatTimestamps					= "Afficher les horodatages dans le chat"
option.chatTimestamps.desc				= "Prépose l'heure à chaque message dans la chatbox."
option.alwaysShowBars					= "Toujours afficher les barres d'informations"
option.alwaysShowBars.desc				= "Affiche les barres d’information en haut à gauche, qu’elles soient masquées ou non."
option.altLower							= "Masquer les mains une fois abaissé" -- @todo remove me
option.altLower.desc					= "Cacher les mains quand elles sont sur les côtés." -- @todo remove me
option.thirdpersonEnabled				= "Activer la troisième personne"
option.thirdpersonEnabled.desc			= "Déplace la caméra derrière toi. Ceci peut également être activé dans la console avec la commande \"ix_togglethirdperson\""
option.thirdpersonClassic				= "Activer la caméra classique à la troisième personne"
option.thirdpersonClassic.desc			= "Déplace la vue de ton personnage avec ta souris."
option.thirdpersonVertical				= "Troisième personne hauteur"
option.thirdpersonVertical.desc			= "À quelle hauteur la caméra devrait être."
option.thirdpersonHorizontal			= "Troisième personne horizontale"
option.thirdpersonHorizontal.desc		= "Quelle distance gauche ou droite la caméra doit être."
option.thirdpersonDistance				= "Troisième personne distance"
option.thirdpersonDistance.desc			= "À quelle distance la caméra doit être."
...
option.disableAnimations				= "Désactiver les animations"
option.disableAnimations.desc			= "Arrête la lecture des animations pour fournir des transitions instantanées."
option.animationScale					= "Échelle d'animation"
option.animationScale.desc				= "A quelle vitesse les animations doivent être faites."
option.language							= "Langue"
option.language.desc					= "La langue affichée dans l'interface utilisateur Helix."
...
option.noticeDuration					= "Durée de la notification"
option.noticeDuration.desc				= "Combien de temps afficher les notifications pour (en secondes)."
option.noticeMax						= "Notification maximum"
option.noticeMax.desc					= "Le nombre de notification affichés avant que les précédentes soient supprimés."
option.chatFontScale					= "Échelle de polices de discussion"
option.chatFontScale.desc				= "A quelle taille doit être la police de discussion."
option.chatOutline						= "Décrire le texte du chat"
option.chatOutline.desc					= "Affiche un contour autour du texte de la discussion plutôt qu’une ombre. Activez cette option si vous rencontrez des difficultés pour lire du texte."

option.show3DPanels 					= "Afficher les panneaux 3D personnalisés"
...
-- Temp Flags
cmd.char.tempflags.give = "Donner des drapeaux temporaires à un personnage. Le temps est spécifié en minutes."
cmd.char.tempflags.extend = "Prolonger (ou réduire) les drapeaux temporaires actuels d'un personnage. Ils expireront après le temps imparti."
cmd.char.tempflags.take = "Retirer les drapeaux temporaires d'un personnage."
cmd.char.tempflags.clear = "Retirer tous les drapeaux temporaires d'un personnage."
cmd.char.tempflags.check = "Vérifier les drapeaux d'un personnage."

tempflags.give = "%s a donné à %s les drapeaux '%s' pour %d minutes."
tempflags.alreadyGiven = "%s possède déjà les drapeaux '%s', ou ces drapeaux n'existent pas."
tempflags.alreadyTaken = "%s ne possède pas les drapeaux '%s'."
tempflags.take = "%s a retiré les drapeaux temporaires '%s' à %s."
tempflags.noClear = "%s ne possède aucun drapeau temporaire."
tempflags.expired = "Les drapeaux temporaires '%s' du personnage %s ont expiré."
tempflags.expireWarn = "Vos drapeaux temporaires '%s' expireront dans 5 minutes."
tempflags.check = "Ce personnage possède les drapeaux '%s'."

config.tempFlagsRemove.desc = "Faut-il supprimer tous les drapeaux temporaires lorsque le joueur change de personnage."


spawn.ui.itemGive 						= "Se donner"
spawn.ui.itemCopyID						= "Copier l'ID de l'objet"
spawn.ui.itemCustomItems 				= "Objets personnalisés"
spawn.ui.items 							= "Objets"

storageCloseHint						= "[TAB] — fermer le stockage"
...
equip.radio								= "RADIO"
equip.ears								= "OREILLES"
equip.shoulder							= "ÉPAULE"
equip.legs								= "JAMBES"
equip.hands								= "MAINS"
equip.backpack							= "SAC À DOS"
equip.you								= "VOUS"

body.fullBody							= "CORPS ENTIER"
body.head								= "Tête"
body.torso								= "Torse"
body.stomach							= "Abdomen"
body.leftArm							= "Bras gauche"
body.rightArm							= "Bras droit"
body.leftLeg							= "Jambe gauche"
body.rightLeg							= "Jambe droite"

ui.close								= "FERMER"
ui.searchEnter							= "Appuyez sur Entrée pour chercher"
ui.searchBtn							= "Appuyez pour chercher"
ui.searchResults						= "%s résultats pour \"%s\""

chargen.faceLabel						= "VISAGE : "
chargen.hairLabel						= "CHEVEUX : "
chargen.attribute						= "ATTRIBUT DU PERSONNAGE"
chargen.heightFmt						= "%%s cm"

mainmenu.x86Warning						= "Installez la version x86-64 du jeu."
mainmenu.needCharacter					= "Vous devez avoir au moins un personnage !"

mainmenu.btnNewArrival					= "NOUVELLE ARRIVÉE"
mainmenu.btnCharacters					= "PERSONNAGES"
mainmenu.btnContent						= "CONTENU"
mainmenu.btnInfo						= "INFORMATIONS"
mainmenu.btnClose						= "FERMER"
mainmenu.hintTitle						= "PROTECTION CIVILE"
mainmenu.hintText						= "Les agents de la Protection Civile ne sont pas seulement des joueurs qui frappent les autres — ce sont aussi des personnages intéressants. Bien que les agents soient généralement peu bavards, beaucoup d'entre eux sont corrompus et peuvent avoir des liens avec la Résistance. N'hésitez pas à vous adresser aux agents si vous souhaitez apprendre ou partager quelque chose."
mainmenu.versionLabel					= "VERSION #28"
mainmenu.warningText					= "Protégé par le système d'anonymat version 5."
mainmenu.patchTitle						= "Patch 28.6 :"
mainmenu.patchCore						= "NOYAU :"
mainmenu.patchCoreText					= "Préparation du noyau pour les modifications d'interface prévues."
mainmenu.patchDate						= "22.09.2024 :"
mainmenu.patchNew						= "NOUVEAU :"
mainmenu.patchNewText					= "Ajout d'objets : Pantalon noir, Pantalon blanc, Pantalon noir avec ceinture, Veste noire, Veste blanche, Veste noire avec manteau."