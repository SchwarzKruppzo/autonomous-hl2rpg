...
hasBag							= "No puedes llevar más de una bolsa."
...
charcreate_faction				= "FACCIÓN /// CREACIÓN DE PERSONAJE"
charcreate_visual				= "APARIENCIA /// CREACIÓN DE PERSONAJE"
charcreate_left					= "BIOGRAFÍA DEL PERSONAJE"
charcreate_right				= "APARIENCIA"

charcreate_name					= "NOMBRE"
charcreate_random				= "NOMBRE ALEATORIO"
charcreate_phys					= "DESCRIPCIÓN FÍSICA"

char_age						= "EDAD: "
char_height						= "ALTURA: "
char_eye						= "COLOR DE OJOS: "
char_shape						= "COMPLEXIÓN: "
char_lang						= "IDIOMA MATERNO: "

charcreate_secondary			= "ADICIONAL"
charcreate_type					= "ELEGIR GÉNERO"
charcreate_model				= "APARIENCIA"

charcreate_back					= "ATRÁS"
charcreate_next					= "SIGUIENTE"
charcreate_apply				= "CREAR PERSONAJE"
charcreate_attributes			= "ATRIBUTOS /// CREACIÓN DE PERSONAJE"
charcreate_available			= "DISPONIBLE"
charcreate_freePoints			= "PUNTOS LIBRES"
charcreate_choose				= "ELEGIR"
charcreate_primaryAttributes	= "ATRIBUTOS PRINCIPALES"
charcreate_primaryAttribute		= "ATRIBUTO PRINCIPAL"
charcreate_primaryAttributeDesc	= "ATRIBUTO DEL PERSONAJE"
charcreate_primaryAttributeHint	= "Afecta al coste de aumentar el atributo del personaje. El atributo principal se aumenta sin penalización; el resto cuesta 4 puntos."
charcreate_citizen				= "CIUDADANO"
tab_characteristics				= "ATRIBUTOS"
tab_health						= "ESTADO DE SALUD"
tab_info						= "INFORMACIÓN RP"
tab_perks						= "VENTAJAS"
tab_equipment					= "EQUIPO"
label_cid						= "ID DE CIUDADANO"
panel_developing					= "Panel en desarrollo."
tab_character						= "PERSONAJE"
tab_equip_outer					= "ROPA EXTERIOR"
tab_equip_under					= "ROPA INTERIOR"
tab_craft							= "CREACIÓN"
tab_to_mainmenu					= "MENÚ PRINCIPAL"
...
tab_tokens							= "FICHAS"
tab_level							= "NIVEL"
tab_xp_until						= "HASTA EL SIGUIENTE: %s XP"
tab_profile						= "PERFIL DEL PERSONAJE"
tab_basics							= "BÁSICO"
tab_phys_desc						= "DESCRIPCIÓN FÍSICA"
tab_appearance_desc				= "DESCRIPCIÓN EXTERIOR"
tab_notes							= "NOTAS PERSONALES"
tab_skills							= "HABILIDADES"
tab_special_tooltip				= "ATRIBUTO DEL PERSONAJE"
tab_consciousness					= "CONCIENCIA:"
tab_pain							= "DOLOR:"
tab_hunger							= "HAMBRE:"
tab_thirst							= "SED:"
tab_health_label					= "SALUD:"
tab_backpack						= "MOCHILA"
tab_slot_torso						= "TORSO"
tab_slot_head						= "CABEZA"
tab_slot_legs						= "PIERNAS"
tab_slot_face						= "ROSTRO"
tab_slot_ears						= "OREJAS"
tab_slot_shoulder					= "HOMBRO"
tab_slot_hands						= "MANOS"
tab_radio							= "RADIO"
tab_name							= "NOMBRE"
tab_gender							= "GÉNERO"
n_a									= "N/D"
...
Outfit							= "Atuendo"
Weapons							= "Armas"
itemContrabandWarning				= "Es contrabando: la posesión y el transporte están prohibidos."
...
charDeleted						= "¡El personaje %s fue eliminado!"
charBanned						= "Este personaje está baneado."
charBannedTemp					= "Este personaje está baneado temporalmente."
...
vendorUseMoney					= "¿El vendedor usa dinero?"
vendorNoBubble					= "¿Ocultar la burbuja del vendedor?"
category						= "Categoría"
mode							= "Modo"
price							= "Precio"
stock							= "Stock"
...
equippedBag						= "¡No puedes mover una bolsa que contiene un objeto equipado!"
equippedWeapon					= "¡No puedes mover un arma que está equipada actualmente!"
nestedBags						= "¡No puedes poner un inventario dentro de otro inventario de almacenamiento!"
outfitAlreadyEquipped			= "¡Ya estás usando este tipo de atuendo!"
Load							= "Cargar"
...
edit							= "Editar"
disable							= "Desactivar"
vendorPriceReq					= "Introduce el nuevo precio para este objeto."
vendorEditCurStock				= "Editar Stock Actual"
vendorStockReq					= "Introduce la cantidad máxima de stock que debería tener el objeto."
vendorStockCurReq				= "Introduce cuántos objetos están disponibles para comprar del stock máximo."
you								= "Tú"
...
vendorMaxStock					= "¡Este vendedor tiene stock completo de ese objeto!"
contentTitle					= "Contenido de Helix Faltante"
contentWarning					= "No tienes el contenido de Helix montado. Esto puede causar que algunas características falten.\n¿Deseas abrir la página del Workshop para el contenido de Helix?"
flags							= "Flags"
mapRestarting					= "¡El mapa se reiniciará en %d segundos!"
chooseTip						= "Escoge este personaje para jugar con él."
deleteTip						= "Borra este personaje."
storageInUse					= "¡Alguien más está usando esto!"
...
option.openBags						= "Abrir objetos con inventario"
option.openBags.desc				= "Abrir automáticamente todos los objetos con inventario cuando el menú es abierto."
option.showIntro					= "Mostrar la intro al entrar"
option.showIntro.desc				= "Muestra la introducción de Helix la siguiente vez que entres. Esta opción siempre es deshabilitada una vez la has visto."
option.cheapBlur					= "Deshabilitar difuminación"
option.cheapBlur.desc				= "Remplaza la difuminación de la interfaz con un oscurecido simple."
option.observerTeleportBack			= "Volver a la posición anterior"
option.observerTeleportBack.desc	= "Te hace volver a la posición en la cual te encontrabas antes de entrar en modo observador."
option.observerESP					= "Mostrar admin ESP"
option.observerESP.desc				= "Muestra los nombres y las localizaciones de cada jugador en el servidor."
option.hour24Time					= "Usar formato de 24 horas"
option.hour24Time.desc				= "Muestra las marcas de tiempo en formato 24 horas, en vez de usar el formato de 12 horas (AM/PM)."
option.chatNotices					= "Mostrar avisos en el chat"
option.chatNotices.desc				= "Pone todos los avisos que aparecen en la esquina superior derecha, en el chat."
option.chatTimestamps				= "Mostrar marcas de tiempo en el chat"
option.chatTimestamps.desc			= "Prepone una marca temporal a cada mensaje en el chat."
option.alwaysShowBars				= "Mostrar siempre las barras de información"
option.alwaysShowBars.desc			= "Siempre muestra las barras de información en la esquina superior izquierda, sin importar si deberían de mostrarse o no."
option.altLower						= "Ocultar las manos al estar bajadas" -- @todo remove me
option.altLower.desc				= "Oculta tus manos cuando están bajadas." -- @todo remove me
option.thirdpersonEnabled			= "Activar Tercera Persona"
option.thirdpersonEnabled.desc		= "Pone la cámara detrás de ti. Esto también puede ser activado con el comando de consola \"ix_togglethirdperson\"."
option.thirdpersonClassic			= "Activar el estilo clásico de tercera persona"
option.thirdpersonClassic.desc		= "Mueve la vista de tu personaje con tu ratón."
option.thirdpersonVertical			= "Altura de Tercera Persona"
option.thirdpersonVertical.desc		= "Como de alto debería de estar la cámara de tercera persona."
option.thirdpersonHorizontal		= "Horizontal de Tercera Persona"
option.thirdpersonHorizontal.desc	= "Como de lejos a la izquierda o la derecha debería de estar la cámara."
option.thirdpersonDistance			= "Distancia de Tercera Persona"
option.thirdpersonDistance.desc		= "Como de lejos debería de estar la cámara."
option.thirdpersonCrouchOffset		= "Altura de la cámara al agacharse"
option.thirdpersonCrouchOffset.desc	= "A que altura debe de estar la cámara cuando se está agachado."
option.disableAnimations			= "Desactivar animaciones"
option.disableAnimations.desc		= "Elimina las animaciones de la interfaz de usuario, haciendo que las transiciones sean instantáneas."
option.animationScale				= "Escala de animación"
option.animationScale.desc			= "Velocidad de reproducción de las animaciones de la interfaz de usuario."
option.language						= "Idioma"
option.language.desc				= "El idioma mostrado en la interfaz de usuario de Helix."
option.minimalTooltips				= "Información del HUD minimalista"
option.minimalTooltips.desc			= "Cambia el estilo de la información del HUD para que ocupe menos espacio."
option.noticeDuration				= "Duración de Avisos"
option.noticeDuration.desc			= "Cuanto tiempo duran los avisos (en segundos)."
option.noticeMax					= "Máximo de Avisos"
option.noticeMax.desc				= "La cantidad de avisos mostrados antes de que sean eliminados los anteriores."
option.chatFontScale				= "Tamaño de fuente del chat"
option.chatFontScale.desc			= "Modifica el tamaño de la fuente del chat."
option.chatOutline					= "Contorno en el texto de chat"
option.chatOutline.desc				= "Dibuja un contorno alrededor del texto del chat, en vez de una sombra paralela. Activa esto si tienes problemas leyendo el texto."
option.show3DPanels 				= "Mostrar paneles 3D personalizados"
...
Instructions						= "Información"

-- Temp Flags
cmd.char.tempflags.give = "Dar banderas temporales a un personaje. El tiempo se especifica en minutos."
cmd.char.tempflags.extend = "Extender (o reducir) las banderas temporales actuales de un personaje. Expirarán después del tiempo indicado."
cmd.char.tempflags.take = "Quitar las banderas temporales de un personaje."
cmd.char.tempflags.clear = "Quitar todas las banderas temporales de un personaje."
cmd.char.tempflags.check = "Comprobar las banderas de un personaje."

tempflags.give = "%s ha dado a %s las banderas '%s' durante %d minutos."
tempflags.alreadyGiven = "%s ya tiene las banderas '%s', o estas banderas no existen."
tempflags.alreadyTaken = "%s no tiene las banderas '%s'."
tempflags.take = "%s ha quitado las banderas temporales '%s' a %s."
tempflags.noClear = "%s no tiene ninguna bandera temporal."
tempflags.expired = "Las banderas temporales '%s' del personaje %s han expirado."
tempflags.expireWarn = "Tus banderas temporales '%s' expirarán en 5 minutos."
tempflags.check = "Este personaje tiene las banderas '%s'."

config.tempFlagsRemove.desc = "¿Se deben eliminar todas las banderas temporales cuando el jugador cambie de personaje?"


spawn.ui.itemGive 					= "Darse a sí mismo"
spawn.ui.itemCopyID					= "Copiar ID del objeto"
spawn.ui.itemCustomItems 			= "Objetos personalizados"
spawn.ui.items 						= "Objetos"

storageCloseHint					= "[TAB] — cerrar almacenamiento"
...
equip.radio							= "RADIO"
equip.ears							= "OREJAS"
equip.shoulder						= "HOMBRO"
equip.legs							= "PIERNAS"
equip.hands							= "MANOS"
equip.backpack						= "MOCHILA"
equip.you							= "TÚ"

body.fullBody						= "CUERPO COMPLETO"
body.head							= "Cabeza"
body.torso							= "Torso"
body.stomach						= "Abdomen"
body.leftArm						= "Brazo izquierdo"
body.rightArm						= "Brazo derecho"
body.leftLeg						= "Pierna izquierda"
body.rightLeg						= "Pierna derecha"

ui.close							= "CERRAR"
ui.searchEnter						= "Presiona Enter para buscar"
ui.searchBtn						= "Presiona para buscar"
ui.searchResults					= "%s resultados para \"%s\""

chargen.faceLabel					= "ROSTRO: "
chargen.hairLabel					= "CABELLO: "
chargen.attribute					= "ATRIBUTO DEL PERSONAJE"
chargen.heightFmt					= "%%s cm"

mainmenu.x86Warning					= "Instala la versión x86-64 del juego."
mainmenu.needCharacter				= "¡Debes tener al menos un personaje!"

mainmenu.btnNewArrival				= "NUEVA LLEGADA"
mainmenu.btnCharacters				= "PERSONAJES"
mainmenu.btnContent					= "CONTENIDO"
mainmenu.btnInfo					= "INFORMACIÓN"
mainmenu.btnClose					= "CERRAR"
mainmenu.hintTitle					= "PROTECCIÓN CIVIL"
mainmenu.hintText					= "Los agentes de Protección Civil no son solo jugadores que golpean a otros — también son personajes interesantes. Aunque los agentes suelen ser lacónicos, muchos de ellos son corruptos y pueden tener vínculos con la Resistencia. Siempre acude a los agentes si quieres saber o contar algo."
mainmenu.versionLabel				= "VERSIÓN #28"
mainmenu.warningText				= "Protegido por el sistema de anonimato versión 5."
mainmenu.patchTitle					= "Parche 28.6:"
mainmenu.patchCore					= "NÚCLEO:"
mainmenu.patchCoreText				= "Preparación del núcleo para los cambios de interfaz planificados."
mainmenu.patchDate					= "22.09.2024:"
mainmenu.patchNew					= "NUEVO:"
mainmenu.patchNewText				= "Objetos añadidos: Pantalones negros, Pantalones blancos, Pantalones negros con cinturón, Chaqueta negra, Chaqueta blanca, Chaqueta negra con abrigo."