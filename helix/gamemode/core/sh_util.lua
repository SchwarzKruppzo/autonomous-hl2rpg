...
function ix.util.Slur(phrase, slurLetters)
	...
	for i = 1, leng do
		...
		if math.random() < 0.3333 then
			...
			if lowerChar == "o" then
				newChar = "u"
			elseif lowerChar == "с" then
				newChar = "сш"
			elseif lowerChar == "а" then
				newChar = "ах"
			end
		end
...
function ix.util.Stutter(phrase, stamina_loss)
	...
	for i = 1, #split_phrase do
		...
		if string.utf8lower(first_sound) == "c" or string.utf8lower(first_sound) == "ш" or string.utf8lower(first_sound) == "х" then
