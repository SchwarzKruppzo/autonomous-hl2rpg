...
cmd.area.edit 					= "Вход в режим редактирования зоны."

option.showArea 				= "Показывать названия улиц"

config.areaTickTime.desc 		= "Сколько секунд проходит между каждым расчетом текущей зоны персонажа."