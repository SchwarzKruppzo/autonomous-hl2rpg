...
cmd.area.edit 					= "Enters area edit mode."

option.showArea 				= "Show Area Notification"

config.areaTickTime.desc 		= "How many seconds between each time a character's current area is calculated."